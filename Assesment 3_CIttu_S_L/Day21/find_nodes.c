/*
Program header 
1.Objective: Write function to find all nodes in list having data field value greater than given input and print their position.
            - User input: search key
            - Find all nodes having value greater than key.
            - save position values in an array.
            - Display the position of those nodes
2.Revisions: Nil
